...
Short entry points for backend work.
...
- KEYWORD_SEARCH_FIX_SUMMARY.md: Summary of fixes and affected files.
- MIGRATION_STEPS.md: Quick migration steps and test commands.
